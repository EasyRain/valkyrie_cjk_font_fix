return {
    ...
    localize_labels_description = {
        en = "Translate the card labels (Name:, Class:, Special Ability:, ...) to follow the game's current language.",
        ["zh-cn"] = "将名片标签（名字、职业、特殊能力等）翻译为游戏当前语言。",
        ["zh-tw"] = "將名片標籤（名字、職業、特殊能力等）翻譯為遊戲目前語言。",
        ja = "名刺のラベル（名前、クラス、特殊能力など）をゲームの現在の言語に翻訳します。",
        ko = "명함 라벨(이름, 직업, 특수 능력 등)을 게임의 현재 언어로 번역합니다.",
    },
    card_label_name = {
        en = "Name:",
        fr = "Nom :",
